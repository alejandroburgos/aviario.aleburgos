        ...
        <>
            <div className="mb-spacing-6">
                <Grid container spacing={6}>
                    <Grid item sm={12} md={12} xl={5}>
                        <Card className="card-box px-4 pt-4 text-center">
                            <Box className="card-tr-actions">
                                <Button variant="text" onClick={handleClick} className="p-0 d-30 border-0 btn-transition-none text-dark" disableRipple>
                                ...
                                <Menu anchorEl={anchorEl}
                                    ...
                                    <div className="dropdown-menu-lg overflow-hidden p-0">
                                        <List component="div" className="nav-pills nav-neutral-primary flex-column p-3">
                                            <ListItem component="a" button href="#/" onClick={e => e.preventDefault()}>
                                                <span>My Account</span>
                                            </ListItem>
                                            <ListItem component="a" button href="#/" onClick={e => e.preventDefault()} selected>
                        ...
                        <Grid container spacing={6}>
                                    ...
                                    <div className="my-2">
                                        <div className="d-flex py-4 align-items-center">
                                            <div className="d-60 rounded border-0 card-icon-wrapper flex-shrink-0 bg-first text-white btn-icon text-center shadow-first mr-3">
                                                {/* <FontAwesomeIcon icon={['far', 'comment-dots']} className="display-4"/> */}
                                            </div>
                                        ...
                                        <div className="text-black-50 font-weight-bold mb-2">
                                            <a className="text-first" href="#/" onClick={e => e.preventDefault()}>See reviews</a> that were left by past customers from USA.
                                        </div>
                                    </div>
                                </Card>
                            </Grid>
                                    ...
                                    <div className="my-2">
                                        <div className="d-flex py-4 align-items-center">
                                            <div className="d-60 rounded border-0 card-icon-wrapper flex-shrink-0 bg-warning text-white btn-icon text-center shadow-warning mr-3">
                                                {/* <FontAwesomeIcon icon={['fas', 'map-marked-alt']} className="display-4"/> */}
                                            </div>
                                            <div className="display-3 font-weight-bold ml-1">
                                                12.87%
                                            </div>
                                        ...
                                        <div className="text-black-50 font-weight-bold mb-2">
                                            <a className="text-first" href="#/" onClick={e => e.preventDefault()}>See visits</a> that had a higher than expected bounce rate.
                                        </div>
                                    </div>
                                </Card>
                            </Grid>
                            <Grid item md={6}>
                                <Card className="card-box p-4">
                                    ...
                                    <div className="my-2">
                                        <div className="d-flex py-4 align-items-center">
                                            <div className="d-60 rounded border-0 card-icon-wrapper flex-shrink-0 bg-danger text-white btn-icon text-center shadow-danger mr-3">
                                                {/* <FontAwesomeIcon icon={['far', 'envelope']} className="display-4"/> */}
                                            </div>
                                            <div className="display-3 font-weight-bold ml-1">
                                                175
                                            </div>
                                    ...
                                    <div className="text-black-50 font-weight-bold mb-2">
                                        <a className="text-first" href="#/" onClick={e => e.preventDefault()}>See referring</a> domains that sent most visits last month.
                                    </div>
                                </Card>
                            </Grid>
                            <Grid item md={6}>
                                <Card className="card-box p-4">
                                    ...
                                    <div className="my-2">
                                        <div className="d-flex py-4 align-items-center">
                                            <div className="d-60 rounded border-0 card-icon-wrapper flex-shrink-0 bg-success text-white btn-icon text-center shadow-success mr-3">
                                                {/* <FontAwesomeIcon icon={['fas', 'tachometer-alt']} className="display-4"/> */}
                                            </div>
                                            <div className="display-3 font-weight-bold ml-1">
                                                64.39%
                                            </div>
                                    ...
                                    <div className="text-black-50 font-weight-bold mb-2">
                                        <a className="text-first" href="#/" onClick={e => e.preventDefault()}>See clients</a> that accepted your invitation to connect.
                                    </div>
                                </Card>
                            </Grid>
                        </Grid>
